...
pub fn extract_schema_policy(gp: &ast::GlobalPolicy) -> Result<SchemaPolicy, Box<dyn Error>> {
...
impl ExtractionContext {
    ...
    fn extract_schema_policy(self, gp: &ast::GlobalPolicy) -> Result<SchemaPolicy, Box<dyn Error>> {
    ...
    fn extract_coll_policy(
        &self,
        cp: &ast::CollectionPolicy,
    ) -> Result<CollectionPolicy, Box<dyn Error>> {
        let coll = self.schema.find_collection(&cp.name).unwrap();
    ...
    fn extract_field_policy(
        &self,
        coll_name: &str,
        fp: &ast::FieldPolicy,
    ) -> Result<FieldPolicy, Box<dyn Error>> {
